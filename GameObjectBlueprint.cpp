...
std::string GameObjectBlueprint::getEncompassingRectColliderTag()
{
	return m_EncompassingRectColliderTag;
}
...
void GameObjectBlueprint::setEncompassingRectColliderTag(std::string toTag)
{
	m_EncompassingRectColliderTag = toTag;
}